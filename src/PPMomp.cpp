...
void PPMomp::blurFilter(const char *outFile){
    ...
    for(int i = 0; i < H; i++){
        for(int j = 0; j < W; j++){
            out << blurred[i][j].r << " " << blurred[i][j].g << " " << blurred[i][j].b << " ";
        }
        out << "\n";
    }
    for(int i = 0; i < H; i++){
...
void PPMomp::laplaceFilter(const char *outFile){
    ...
    for(int i = 0; i < H; i++){
        for(int j = 0; j < W; j++){
            out << laplace[i][j].r << " " << laplace[i][j].g << " " << laplace[i][j].b << " ";
        }
        out << "\n";
    }
    for(int i = 0; i < H; i++){
...
void PPMomp::sharpenFilter(const char *outFile){
    ...
    for(int i = 0; i < H; i++){
        for(int j = 0; j < W; j++){
            out << sharpened[i][j].r << " " << sharpened[i][j].g << " " << sharpened[i][j].b << " ";
        }
        out << "\n";
    }
    for(int i = 0; i < H; i++){
